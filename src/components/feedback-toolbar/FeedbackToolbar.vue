...
<template>
  <div
    class="w-full h-fit p-6 bg-[#373f68] rounded-xl text-white sm:text-sm text-xs flex justify-between items-center md:mt-[100px] md:rounded-none md:bg-transparent"
  >
